		...
		<div style="height: 100vh" class="d-flex align-items-center">
			<div class="container col-sm-10">
				<div class="row shadow" style="border-radius: 1rem">
					<!-- school logo -->
					<div class="col-sm-4 text-center d-none d-sm-block py-5" style="background-image: url(<?= site_url()?>assets/images/631.jpg); background-size: cover">
						<img class="" src="<?= site_url()?>assets/images/school_logo.png" height="150" alt="School Logo">
						<label class="mb-5 p-1 rounded mt-3" style="background: #fff">
						...
						<div class="w-100 px-3 py-4">
							<?= form_open('a/auth/signin') ?>
								<ul class="nav nav-tabs">
									<li class="nav-item">
										<a class="nav-link h4" aria-current="page" href="<?= site_url()?>r">Registrar</a>
									</li>
									<li class="nav-item">
										<a class="nav-link h4 active" href="<?= site_url()?>a">Admin</a>
									</li>
								</ul>
