    ...
    <?= form_open('r/assessment/update')?>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 text-center d-flex align-items-center justify-content-end">
          <img src="<?= (isset($enrollments)) ? $enrollments[0]->user_img : site_url().'assets/images/user.jpg'?>" alt="hugenerd" style="width: 200px; height: 200px; background-color: rgba(0,0,255,.1);" class="img-fluid img-thumbnail rounded" alt="">
        </div>
        <!-- learners information -->
        <div class="col-lg-9">
