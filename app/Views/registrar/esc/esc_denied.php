<main class="p-4">
  ...
  <div class="d-flex justify-content-between border-bottom mb-5">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Denied Applications</li>
      </ol>
    </nav>
  </div>
  ...
  <section class="mb-5">
    ...
    <div class="d-flex justify-content-between gap-3">
      <button class="btn btn-danger btn-sm" onclick="print('dtable', 'esc_denied_report_<?= date('now')?>')"><i class="fas fa-download"></i> Download</button>
      <div class="d-flex justify-content-end gap-3">
        <a href="<?= site_url()?>r/esc_denied" class="btn btn-sm btn-primary">Show All</a>
        <?= form_open('r/esc_denied/searchdate/d') ?>
          <?= csrf_field() ?>
        ...
        <?= form_open('r/esc_denied/searchclass/d') ?>
          <?= csrf_field() ?>
          <div class="input-group input-group-sm">
        ...
        <?= form_open('r/esc_denied/search/d') ?>
          <?= csrf_field() ?>
          <div class="input-group input-group-sm">
  ...
  <section class="mb-5">
    <div class="table-responsive">
      <table id="dtable" class="table table-bordered table-striped align-middle text-center">
        <thead>
          <tr>
            <th></th>
            <th>Request Date</th>
