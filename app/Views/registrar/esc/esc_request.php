<main class="p-4">
  ...
  <section class="mb-5">
    ...
    <div class="d-flex justify-content-end gap-3">
      <a href="<?= site_url()?>r/esc_request" class="btn btn-sm btn-primary">Show All</a>
      <?= form_open('r/esc_request/searchdate/r') ?>
        <?= csrf_field() ?>
      ...
      <?= form_open('r/esc_request/searchclass/r') ?>
        <?= csrf_field() ?>
        <div class="input-group input-group-sm">
      ...
      <?= form_open('r/esc_request/search/r') ?>
        <?= csrf_field() ?>
        <div class="input-group input-group-sm">
