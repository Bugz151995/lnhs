...
<html lang="en">
  ...
  <body class="bg-light" style="min-height: 100vh;">
    ...
    <!-- MAIN CONTENT -->
		<main class="d-flex align-items-center position-relative py-5" style="top: 66px;">
			<div class="container col-sm-10 justify-content-center d-flex">
				<div class="row shadow w-75">
					<!-- school logo -->
					<div class="col-12 text-center d-none d-sm-block pt-5" style="background-image: url(<?= site_url()?>assets/images/631.jpg); background-size: cover">
						...
						<label class="mb-5 p-1 mt-3 rounded display-6 fw-bold" style="background: #fff">
						...
						<div class="w-100 px-3 py-4">
							<?= form_open('r/auth/signin') ?>
								<ul class="nav nav-tabs justify-content-center">
									<li class="nav-item">
										<a class="nav-link h4 active" aria-current="page" href="<?= site_url()?>r"><i class="fas fa-user-tie"></i> Registrar</a>
									</li>
									<li class="nav-item">
										<a class="nav-link h4" href="<?= site_url()?>a"><i class="fas fa-user-shield"></i> Admin</a>
									</li>
								</ul>
