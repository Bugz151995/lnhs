...
<input type="button" value="" id="addTeacherBtn" class="d-none" data-bs-toggle="modal" data-bs-target="#newTeacher">
<!-- Modal -->
<div class="modal fade" id="newTeacher" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newTeacherLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newTeacherLabel"><i class="fas fa-plus-square"></i> <span class="align-middle">Add New Teacher</span></h5>
        <a href="<?= site_url()?>r/teacher_list" role="button" class="btn-close" aria-label="Close"></a>
      </div>
      
      <?= form_open_multipart('r/teacher_list/create') ?>
        <?= csrf_field() ?>
      <div class="modal-body px-3">
        ...
        <div class="row mb-3 g-3">
          ...
          <div class="col">
            ...
            <input type="text" name="suf" id="suf" class="form-control" placeholder="Suffix">
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col">
            ...
            <input type="text" name="email" id="email" class="form-control" placeholder="Suffix">
          ...
          <div class="col">
            ...
            <input type="text" name="cn" id="cn" class="form-control" placeholder="Contact Number">
