          ...
          <div class="modal-body">
            ...
            <div id="aboutme" class="row row-cols-1 row-cols-lg-3 g-3">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control form-control-sm " id="nameextension" name="suffix" value="<?= set_value('suffix')?>" placeholder="Name Extension here...">
              </div>
              <div class="col">
              ...
              <div class="col">
                ...
                <input type="text" id="bplace" name="bplace" value="<?= set_value('bplace')?>" class="form-control form-control-sm" placeholder="Birth Place here...">
              </div>
              <div class="col">
              ...
              <div class="col">
                ...
                <input type="text" id="natl" name="natl" value="<?= set_value('natl')?>" class="form-control form-control-sm" placeholder="Nationality here...">
              </div>
            </div>
          ...
          <div class="modal-body">
            ...
            <div class="row row-cols-1 row-cols-lg-3 g-3"> 
              ...
              <div class="col">
                ...
                <input type="number" id="zip" name="zip" value="<?= set_value('zip')?>" class="form-control form-control-sm " placeholder="Zip Code here...">
              </div>
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-between">
          ...
          <div class="modal-body">
            ...
            <div id="seniorhighstudent" class="row g-3 row-cols-1 align-items-center mb-3">
              ...
              <div class="col-md-3">
                ...
                <select name="gradelevel" id="gradelevel" class="form-select form-select-sm">
