<main class="container">
  <div>
    <section class="row py-5 my-5 py-sm-0 px-2">
      <div class="col-sm-7 text-center text-sm-start d-flex justify-content-start flex-column">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-primary text-light">
          <h5 class="modal-title" id="page0Label"><i class="fas fa-list fa-fw me-1"></i>Enrollment Request Token - Old Student</h5>
          <a href="<?= site_url() ?>" class="btn-close bg-light me-1"></a>
        </div>
        <div class="modal-body">
          <?= form_open_multipart('enrollment/request/old/submit') ?>
          ...
          <div class="row g-3 row-cols-1 px-3">
            ...
            <hr>
            <div class="row row-cols-1 row-cols-lg-3 g-3 mb-3 mt-0">
              <div class="col">
